...
/**************************请求参数**************************/
        ...
        //必填，不能修改
        //服务器异步通知页面路径
        $notify_url = "http://city.5656111.com/Member/PayOnline/hzpay_goodsfare_alinotify";
        //需http://格式的完整路径，不能加?id=123这类自定义参数

        //页面跳转同步通知页面路径
        $return_url = "http://city.5656111.com/Member/PayOnline/hzpay_goodsfare_alireturn";
