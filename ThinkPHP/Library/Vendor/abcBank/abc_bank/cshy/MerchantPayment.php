<?php
//引入支付请求文件
require_once(ABC_PATH.'ebusclient/PaymentRequest.php');
//1、创建支付请求对象
...
$orderitem = array ();
$orderitem["SubMerName"] = "城市配送"; //设定二级商户名称
$orderitem["SubMerId"] = "12345"; //设定二级商户代码
$orderitem["SubMerMCC"] = "0000"; //设定二级商户MCC码 
$orderitem["SubMerchantRemarks"] = "城配"; //二级商户备注项
$orderitem["ProductID"] = "IP000001"; //商品代码，预留字段
$orderitem["ProductName"] = "托管运费"; //商品名称
$orderitem["UnitPrice"] = "1.00"; //商品总价
$orderitem["Qty"] = "1"; //商品数量
$orderitem["ProductRemarks"] = "商品2"; //商品备注项
...
if ($tResponse->isSuccess()) {
	...
	echo "ReturnMsg   = [" . $tResponse->getErrorMessage() . "]</br>";
	echo "请刷新跳转前的页面重新提交支付</br>";
}
?>
